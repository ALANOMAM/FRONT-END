...
//funzione che gestisce l'immagine di profilo
//cioè se cè la foto mi ritorna la foto, sde invece non ce, mi ritorna le iniziali del nome utente
 function getImage( element){
if(element.foto != null){

  return `<img class="profile-image" src=${element.foto} alt="profile img">`
